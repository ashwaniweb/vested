            ...
            <section className="theBenefits">
                <Grid>
                    ...
                    <Row>
                        <Col xs={12} md={4}>
                            <img
                                src="/images/home/group-5.png"
                                alt="Stand Apart"
                            />
                            <div className="box">
                                <h4>Lower Time to Fill</h4>
                                <p>
                                    Vested screens and assesses all candidates
                                    to save you time
                                </p>
                            </div>
                        </Col>
                        ...
                        <Col xs={12} md={4}>
                            <img
                                src="/images/home/reduceAttrition.svg"
                                alt="Stand Apart"
                            />
                            <div className="box">
                                <h4>Reduce Attrition</h4>
                                <p>
                                    Identify candidates that fit your company’s
                                    culture to minimize turnover
                                </p>
                            </div>
                        </Col>
                    </Row>
